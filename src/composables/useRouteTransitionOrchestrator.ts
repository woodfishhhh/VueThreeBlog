...
type TransitionKind = "panelTransition" | "pageToPost" | "postToPage" | "overlayOpen" | "overlayClose";
...
export async function playRouteTransition(options: { kind: TransitionKind; directEntry?: boolean }) {
