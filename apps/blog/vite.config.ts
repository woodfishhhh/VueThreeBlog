...
export default defineConfig({
  ...
  run: {
    tasks: {
      ...
      "agent:dist": {
        command:
          "cross-env VITE_BASE_PATH=/newBlog/ vp run app:build && cross-env VITE_BASE_PATH=/newBlog/ tsx ../../packages/content-tools/src/cli.ts verify-dist --app-root . --base-path /newBlog/",
      },
      "agent:fast": {
      ...
      "content:index": {
        command: "tsx ../../packages/content-tools/src/cli.ts generate",
        input: ["content/**", "package.json", "../../packages/content-tools/src/**"],
        output: [
          "src/generated/**",
      ...
      "content:index:ci": {
        command: "tsx ../../packages/content-tools/src/cli.ts generate --reuse-assets",
        input: [{ auto: true }],
        output: ["src/generated/**"],
      },
      "deploy:build": {
        command:
          "vp run content:generate:ci && cross-env VITE_BASE_PATH=/newBlog/ vp run app:build && cross-env VITE_BASE_PATH=/newBlog/ tsx ../../packages/content-tools/src/cli.ts verify-dist --app-root . --base-path /newBlog/",
      },
      "dist:verify": {
        command: "tsx ../../packages/content-tools/src/cli.ts verify-dist",
      ...
      "images:optimize": {
        command: "tsx ../../packages/content-tools/src/cli.ts optimize-images",
        input: [{ auto: true }],
